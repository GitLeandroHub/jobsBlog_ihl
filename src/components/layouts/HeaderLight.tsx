...
import ihlLogo from '../../images/invisible_logo_light2.png';
import ihlLogoDark from '../../images/invisible_logo_dark.png';
      ...
      <div className="flex items-center justify-between px-4 py-3 lg:p-0 ">
        <div>
          <LocalizedLink to="/blog">
            <img className="ihl-logo-large" src={isOpen ? ihlLogoDark : ihlLogo} alt="ihl Logo" />
          </LocalizedLink>
        </div>
